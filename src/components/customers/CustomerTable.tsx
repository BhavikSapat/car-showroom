        ...
        <table className="w-full text-left border-collapse">
          <thead className="bg-[#F9FAFB] text-[10px] font-semibold text-[#71717A] uppercase tracking-wider border-b border-[#E4E4E7]">
            <tr>
              ...
              <th className="px-6 py-3">
                <button
                  onClick={() => onSortChange("bookingDate")}
                  className="flex items-center gap-1 hover:text-[#18181B] transition-colors uppercase font-semibold"
                >
              ...
              <tr key={c.id} className="hover:bg-[#F9FAFB] transition-colors">
                ...
                <td className="px-6 py-4 text-center">
                  <span
                    className={`inline-block px-2.5 py-0.5 rounded-full text-[10px] font-bold border ${
                      c.marketing?.toLowerCase() === "interested"
                ...
                <td className="px-6 py-4 text-right">
                  <div className="flex justify-end gap-2">
                    <button
                      onClick={() => onView(c)}
                      className="text-[10px] border px-2.5 py-1 rounded border-[#E4E4E7] hover:bg-[#F4F4F5] text-[#18181B] font-medium transition-colors"
                    >
                      View
                    </button>
                    <button
                    ...
                    {/* {isOwner ? (
                      <button
                        onClick={() => onDelete(c)}
                        className="text-[10px] border px-2.5 py-1 rounded border-red-200 text-red-600 hover:bg-red-50 font-medium transition-colors"
                      >
                        Delete
                      </button>
                    ) : null} */}
