      ...
      >
        ...
        <div className="shrink-0">
          ...
          >
            ...
            <option value="search_name">Search by Name (Contains)</option>
            <option value="search_email">Search by Email (Contains)</option>
            <option value="filter_name">Filter by Name (Exact)</option>
            <option value="filter_email">Filter by Email (Exact)</option>
            <option value="filter_date">Filter by Booking Date</option>
            {/* <option value="query_name">Name Query</option>
            <option value="query_email">Email Query</option>
            <option value="query_date">Date Query</option> */}
          </select>
        </div>
